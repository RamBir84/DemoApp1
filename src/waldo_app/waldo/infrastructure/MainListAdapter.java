...
import waldo_app.waldo.R.color;
...
public class MainListAdapter extends ArrayAdapter<ListItem> {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		CircleImageView profilePicture = (CircleImageView) rowView
				.findViewById(R.id.listProfileImage);
		...
		Drawable IconImageAsDrawable = context.getResources().getDrawable(
				R.drawable.ic_invisible_waldo);
		...
		case request_received:
			IconImageAsDrawable = context.getResources().getDrawable(
					R.drawable.ic_icon_request_received_bg);
			searchIcon.setId(3);
			break;

		case answer_received:
			IconImageAsDrawable = context.getResources().getDrawable(
					R.drawable.ic_icon_answer_received_bg);
			searchIcon.setId(4);
			break;
		default:
	...
	private class ExtendedTarget implements Target {
		...
		public void onBitmapLoaded(Bitmap b, LoadedFrom arg1) {
			...
			// Put the bitmap and the position in reButton
			refButton.setTag(new BitmapPosition(b, (Integer) refButton.getTag()));
		}
